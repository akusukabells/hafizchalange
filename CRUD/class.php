                                ...
                                ?>
                                            <form method="post" action="../API/class.php">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="idclass" value="<?php echo $row['idclass'] ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleFormControlInput1">Class Name</label>
                                                    <input type="text" class="form-control" name="nameclass" placeholder="Class Name" value="<?php echo $row['nameclass'] ?>">
                                                </div>
