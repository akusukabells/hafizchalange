                                ...
                                ?>
                                        <form method="post" action="../API/reward.php">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="juara_1" placeholder="Juara 1" value="<?php echo $row['juara1']; ?>">
                                            </div>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">Juara 2</div>
                                                </div>
                                                <input type="text" class="form-control" name="juara_2" placeholder="Juara 2" value="<?php echo $row['juara2']; ?>">
                                            </div>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">Juara 3</div>
                                                </div>
                                                <input type="text" class="form-control" name="juara_3" placeholder="Juara 3" value="<?php echo $row['juara3']; ?>">
                                            </div>
                                    ...
                                    <form method="post" action="../API/reward.php">
                                        ...
                                        <button class="btn btn-primary btn-block btn-round" name="tambahreward" style="margin-top:50px;float:right !important;">Save</button>
